...
Per the [product page](https://www.codbex.com/products/), Atlas is the **all-in-one edition containing every standard component** — JavaScript development, UIs, debugging, Git, databases, jobs, messaging, security, BPM, and CMS — intended for exploring the full feature set and its applicability across scenarios.
