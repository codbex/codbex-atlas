...
public class TestProject {
    ...
    public TestProject(IRepository dirigibleRepo, BrowserFactory browserFactory, Atlas atlas, EdmView edmView,
    ...
    public void publish() {
        ...
        DirigibleWorkbench workbench = atlas.openWorkbench();
    ...
    public void verifyHomePageAccessibleByTenant(DirigibleTestTenant tenant) {
        ...
        Atlas atlas = new Atlas(browser, tenant.getUsername(), tenant.getPassword());
        boolean forceLogin = !tenant.isDefaultTenant();
        atlas.login(forceLogin);
